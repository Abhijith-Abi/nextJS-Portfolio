...
export default function NotFound() {
    return (
        <main className="min-h-screen bg-canvas text-canvas-fg selection:bg-accent selection:text-black font-sans flex flex-col justify-between">
            ...
            <div className="container-width pt-36 pb-20 flex-1 flex flex-col justify-center items-center text-center relative z-10">
                {/* Glowing 404 Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-accent/40 bg-accent/10 text-accent font-mono text-sm mb-6">
                    <span className="w-2 h-2 rounded-full bg-accent animate-ping" />
                    Error Code: 404
                </div>

                <h1 className="text-6xl sm:text-8xl font-extrabold tracking-tight text-foreground font-mono mb-4 text-gradient">
                    404
                </h1>

                <h2 className="text-2xl sm:text-4xl font-bold text-foreground mb-4 max-w-2xl">
                    Page Not Found
                </h2>
                ...
                <div className="w-full max-w-3xl p-6 sm:p-8 rounded-3xl border border-border/60 bg-card/40 backdrop-blur-md text-left">
