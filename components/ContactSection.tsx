          ...
          <aside className="space-y-4 text-sm text-muted">
            <div className="card-surface p-5 sm:p-6">
              ...
              <p className="mt-4 text-xs text-muted">
                Location: Kerala, India · Open to remote and hybrid roles.
              </p>
            </div>
            ...
            <div className="card-surface p-5 sm:p-6">
              ...
              <p className="mt-4 text-xs text-muted">
                I&apos;m especially interested in frontend-heavy roles focused
                on React, Next.js, design systems, and motion design.
              </p>
            </div>
          </aside>
        </div>
