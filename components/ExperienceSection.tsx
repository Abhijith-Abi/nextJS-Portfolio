    ...
    <SectionWrapper id="experience">
      <div className="mb-8 text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-sm text-muted sm:text-base">
          From education platforms to internal tools, I&apos;ve shipped
          production features that balance UX, performance, and maintainability.
        </p>
      </div>
            ...
            >
              ...
              <div className="mt-6 sm:mt-0 sm:w-1/2">
                <div className="card-surface p-4">
                  ...
                  <p className="mt-2 text-xs text-muted">{exp.description}</p>
                  <p className="mt-3 text-[11px] text-slate-400">
                    Key focus: React · Next.js · REST APIs · Performance ·
                    Testing
                  </p>
                </div>
              </div>
