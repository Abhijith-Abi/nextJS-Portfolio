...
export function Footer() {
    return (
        <footer className="relative border-t border-white/[0.08] bg-surface/80 backdrop-blur-2xl pt-16 pb-12 font-sans text-sm">
            <div className="container-width grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                ...
                <div>
                    <div className="flex items-center gap-2.5 mb-4">
                        ...
                        <h3 className="text-base font-bold text-ink font-mono tracking-wider">
                            ABI SOLUTIONS
                        </h3>
                    </div>
                    ...
                    <div className="text-xs text-ink-muted space-y-2 font-mono">
                        ...
                        <p className="flex items-center gap-2">
                            ...
                            <span>abhijithabhijith1999@gmail.com</span>
                        </p>
                        <p className="flex items-center gap-2">
                ...
                <div>
                    <h4 className="text-xs font-mono uppercase tracking-[0.2em] text-accent mb-4 font-bold">
                ...
                <div>
                    ...
                    <div className="pt-3 border-t border-white/[0.08]">
                        <a
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-accent/10 border border-accent/30 text-accent font-mono text-xs hover:bg-accent hover:text-white transition-all duration-200"
                        >
            ...
            <div className="container-width border-t border-white/[0.08] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-[11px] text-ink-muted">
