    ...
    >
      <div className="max-w-xl">
        ...
        <p className="hero-sub mt-5 max-w-xl text-sm text-muted sm:text-base">
          I&apos;m Abhijith, a frontend engineer from Kerala, India with 3+ years
          experience building production-ready interfaces in React and Next.js –
          focused on performance, motion, and developer-friendly UI systems.
        </p>
      ...
      <div className="w-full max-w-xs sm:max-w-sm lg:max-w-md">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-4 text-[11px] text-muted sm:justify-between">
          <div>
            <p className="font-semibold text-slate-100">Abhijith P A</p>
