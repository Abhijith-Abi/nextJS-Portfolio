        ...
        <SectionWrapper id="estimator" index="05" label="Estimator">
            ...
            <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] items-start">
                ...
                <div className="space-y-8">
                    ...
                    <div className="surface rounded-3xl p-6 sm:p-8 border border-white/[0.08] shadow-glow-sm">
                            ...
                            {projectTypes.map((pt) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`group relative rounded-2xl p-4 text-left transition-all duration-300 cursor-pointer ${
                                            isSelected
                                ...
                                return (
                                    ...
                                    >
                                        <div>
                                            ...
                                            <span className="font-mono text-[9px] uppercase tracking-wider text-accent/80">
                                                {feat.category}
                                            </span>
                                        </div>
                                        <div
                ...
                <div className="lg:sticky lg:top-28">
                    <div className="surface relative overflow-hidden rounded-[2.5rem] p-6 sm:p-8 border-2 border-accent/40 shadow-glow bg-surface/95">
                        <div className="pointer-events-none absolute -top-20 -right-20 h-48 w-48 rounded-full bg-accent/20 blur-3xl" />

                        <div className="inline-flex items-center gap-2 rounded-full border border-accent/30 bg-accent/15 px-3 py-1 text-xs font-mono uppercase tracking-[0.2em] text-accent mb-6 font-semibold">
                        ...
                        <div className="border-b border-white/10 pb-6 mb-6">
                            ...
                            <div className="mt-2 flex items-baseline gap-3">
                                <p className="font-display text-4xl sm:text-5xl font-black text-ink">
                                    ~{calculatedWeeks} <span className="text-xl sm:text-2xl font-normal text-accent">Weeks</span>
                                </p>
                            </div>
                            <p className="mt-1 font-mono text-xs text-accent-emerald flex items-center gap-1.5">
                                <CheckCircle2 className="h-3.5 w-3.5" />
                                Iterative Milestones & Weekly CI/CD Demos
                            </p>
                        </div>

                        {/* Recommended Stack Matrix */}
                        <div className="mb-6">
                            <p className="font-mono text-[10px] uppercase tracking-[0.24em] text-ink/50 mb-2.5">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                                {currentType.recommendedStack.map((tech) => (
                                    <span
                                        key={tech}
                                        className="inline-flex items-center gap-1 rounded-lg border border-white/10 bg-background/80 px-2.5 py-1 font-mono text-[10px] text-ink/90"
                                    >
                        ...
                        <div className="mb-8 rounded-2xl border border-white/10 bg-background/60 p-1.5 flex gap-1">
                            <button
                                type="button"
                                onClick={() => setTimelinePreference("standard")}
                                className={`flex-1 rounded-xl py-2 font-mono text-xs transition-all cursor-pointer ${
                        ...
                        <div className="space-y-3">
                            <a
                                ...
                                className="hero-btn-primary group flex w-full items-center justify-center gap-2.5 rounded-2xl py-3.5 text-sm font-bold tracking-tight shadow-glow-sm"
                            >
                            ...
                            <a
                                href="/contact"
                                className="hero-btn-ghost flex w-full items-center justify-center gap-2 rounded-2xl py-3 text-xs font-semibold"
                            >
