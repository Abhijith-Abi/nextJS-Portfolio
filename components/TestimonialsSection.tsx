            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                {testimonials.map((t, idx) => (
                    <FadeIn key={t.author} delay={idx * 0.08}>
                        <div className="surface relative flex h-full flex-col justify-between overflow-hidden rounded-3xl border border-white/[0.08] p-6 sm:p-8 transition-all duration-300 hover:border-accent/40 hover:shadow-glow-sm">
                            ...
                            <div>
                                ...
                                <div className="flex items-center justify-between gap-2 border-b border-white/[0.06] pb-4 mb-5">
                                    ...
                                    <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-accent bg-accent/10 border border-accent/20 px-2.5 py-0.5 rounded-full font-semibold">
                                        {t.category}
                                    </span>
                                </div>
                            ...
                            <div className="mt-8 border-t border-white/[0.06] pt-5">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-right">
                                        <span className="font-display text-lg font-black text-accent block leading-none">
                                            {t.metric}
                                        </span>
